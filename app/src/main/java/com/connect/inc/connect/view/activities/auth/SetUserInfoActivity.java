package com.connect.inc.connect.view.activities.auth;
...
import com.connect.inc.connect.databinding.ActivitySetUserInfoBinding;
import com.connect.inc.connect.model.user.Users;
import com.connect.inc.connect.view.MainActivity;
            ...
            firebaseFirestore.collection("Users").document(firebaseUser.getUid()).set(users)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(getApplicationContext(), "Upated Succesfully", Toast.LENGTH_SHORT).show();
