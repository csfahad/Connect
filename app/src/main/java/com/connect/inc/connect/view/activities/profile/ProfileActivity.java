package com.connect.inc.connect.view.activities.profile;
...
import com.connect.inc.connect.view.activities.starup.SplashScreenActivity;
import com.devlomi.record_view.BuildConfig;
...
import com.connect.inc.connect.databinding.ActivityProfileBinding;
    ...
    private void showDialogSignOut(){
        ...
        builder.setPositiveButton("Sign out", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                startActivity(new Intent(ProfileActivity.this, PhoneLoginActivity.class));
                finish();
            }
        });
